...
BLOCK_COLORS[B.WallGray] = 0xf6f7fb; // near-white concrete
BLOCK_COLORS[B.WallTan] = 0xfbf3e2; // warm off-white
BLOCK_COLORS[B.WallBrick] = 0xf3d9cc; // pale blush
BLOCK_COLORS[B.Window] = 0xb4d2ea; // soft blue glass
BLOCK_COLORS[B.WindowLit] = 0xfff0c6;
BLOCK_COLORS[B.Glass] = 0xdaeefb;
BLOCK_COLORS[B.Roof] = 0xd6d8e4;
