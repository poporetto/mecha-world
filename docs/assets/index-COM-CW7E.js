...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $a(e,t,n){let r=new Float32Array(za),i=new U(0,1,0);return new Ci({name:`SphericalGaussianBlur`,defines:{n:za,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:no(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function eo(){return new Ci({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:no(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function to(){return new Ci({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:no(),fragmentShader:`
	...
	`}var ro=class extends Rt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ci(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=xs(i,i.VERTEX_SHADER,y),S=xs(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Ds(i,x,`vertex`),n=Ds(i,S,`fragment`);B(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
    ...
    `,t.addEventListener(`click`,()=>{t.remove(),e()}),this.root.appendChild(t)}setHP(e){this.hpFill.style.width=Math.max(0,e*100)+`%`,this.hpFill.style.background=e<.3?`linear-gradient(90deg,#ff3b3b,#ff9a3b)`:`linear-gradient(90deg,#26e0a8,#7fdcff)`}showBoss(e){this.bossWrap.style.display=`block`,this.bossName.textContent=`⚠ `+e+` ⚠`}setBossHP(e){this.bossFill.style.width=Math.max(0,e*100)+`%`}hideBoss(){this.bossWrap.style.display=`none`}toast(e,t,n=3.5){document.getElementById(`toast-h`).textContent=e,document.getElementById(`toast-p`).textContent=t,this.toastEl.style.opacity=`1`,this.toastTimer=n}unlock(e,t){let n=this.chips[e];n.classList.remove(`locked`),n.innerHTML=t,n.style.borderColor=`#39e6e0`}damageFlash(){this.vignette.style.opacity=`1`,setTimeout(()=>this.vignette.style.opacity=`0`,250)}update(e){this.toastTimer>0&&(this.toastTimer-=e,this.toastTimer<=0&&(this.toastEl.style.opacity=`0`))}},hu=new U;new class{constructor(){Q(this,`renderer`,void 0),Q(this,`scene`,new Tn),Q(this,`camera`,void 0),Q(this,`world`,new pl),Q(this,`chunks`,void 0),Q(this,`player`,void 0),Q(this,`npcs`,void 0),Q(this,`cars`,void 0),Q(this,`debris`,new ou),Q(this,`hud`,new mu),Q(this,`keys`,new Set),Q(this,`mouseDown`,[!1,!1,!1]),Q(this,`drag`,null),Q(this,`lastCollapseScan`,0),Q(this,`camYaw`,0),Q(this,`camPitch`,.32),Q(this,`locked`,!1),Q(this,`started`,!1),Q(this,`projectiles`,[]),Q(this,`laserCooldown`,0),Q(this,`beamMesh`,void 0),Q(this,`beamTick`,0),Q(this,`beamActive`,!1),Q(this,`sky`,void 0),Q(this,`falling`,[]),Q(this,`lastBoomSound`,0),Q(this,`monster`,null),Q(this,`bossPhase`,`pre-kaiju`),Q(this,`bossTimer`,14),Q(this,`clock`,new Ca),Q(this,`time`,0),this.renderer=new Hc({antialias:!0}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(window.devicePixelRatio),document.body.appendChild(this.renderer.domElement),this.camera=new ra(65,window.innerWidth/window.innerHeight,.1,500),this.scene.background=new K(8309239),this.scene.fog=new wn(10411263,110,280);let e=new Gi(15136511,8030834,1.25),t=new oa(16774365,1.35);t.position.set(.6,1,.35),this.scene.add(e,t),this.sky=new fu(t.position.clone().normalize()),this.scene.add(this.sky.group),this.chunks=new bl(this.world,this.scene),this.player=new Rl(this.world),this.player.respawn(),this.scene.add(this.player.model.group),this.npcs=new Kl(this.world),this.cars=new ru(this.world),this.scene.add(this.npcs.group,this.cars.group,this.debris.mesh),this.beamMesh=new q(new fi(.7,.7,1),new Ar({color:3794656,transparent:!0,opacity:.85})),this.beamMesh.visible=!1,this.scene.add(this.beamMesh),this.bindInput(),window.addEventListener(`resize`,()=>{this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight)}),window.__game=this,this.hud.showStart(()=>{this.started=!0,pu.ensure(),this.renderer.domElement.requestPointerLock(),this.hud.toast(`DEPLOYED`,`Explore Neo Tokyo. Something big is coming…`,4)}),this.renderer.setAnimationLoop(()=>this.frame())}bindInput(){window.addEventListener(`keydown`,e=>{(e.code.startsWith(`Arrow`)||e.code===`Space`)&&e.preventDefault(),this.keys.add(e.code),e.code===`KeyF`&&this.fireLaser()}),window.addEventListener(`keyup`,e=>this.keys.delete(e.code)),document.addEventListener(`pointerlockchange`,()=>{this.locked=document.pointerLockElement===this.renderer.domElement}),this.renderer.domElement.addEventListener(`mousedown`,e=>{this.started&&(this.mouseDown[e.button]=!0,this.locked?(e.button===0&&this.swingSaber(),e.button===2&&this.fireLaser()):this.drag={x:e.clientX,y:e.clientY,sx:e.clientX,sy:e.clientY,button:e.button,moved:!1})}),window.addEventListener(`mouseup`,e=>{this.mouseDown[e.button]=!1,this.drag&&e.button===this.drag.button&&(!this.drag.moved&&this.started&&(this.renderer.domElement.requestPointerLock(),e.button===0&&this.swingSaber(),e.button===2&&this.fireLaser()),this.drag=null)}),window.addEventListener(`contextmenu`,e=>e.preventDefault()),window.addEventListener(`mousemove`,e=>{if(this.locked)this.camYaw-=e.movementX*.0026,this.camPitch=Math.max(-.5,Math.min(1.2,this.camPitch+e.movementY*.0022));else if(this.drag){let t=e.clientX-this.drag.x,n=e.clientY-this.drag.y;Math.abs(e.clientX-this.drag.sx)+Math.abs(e.clientY-this.drag.sy)>5&&(this.drag.moved=!0),this.camYaw-=t*.005,this.camPitch=Math.max(-.5,Math.min(1.2,this.camPitch+n*.004)),this.drag.x=e.clientX,this.drag.y=e.clientY}})}aimDir(){return new U(-Math.sin(this.camYaw)*Math.cos(this.camPitch),-Math.sin(this.camPitch)*.6+.05,-Math.cos(this.camYaw)*Math.cos(this.camPitch)).normalize()}swingSaber(){this.player.model.startSwing()&&(this.player.yaw=this.camYaw+Math.PI,pu.swing(),setTimeout(()=>{let e=this.aimDir();for(let t of[-.45,0,.45]){let n=Math.cos(t),r=Math.sin(t),i=new U(e.x*n-e.z*r,e.y,e.x*r+e.z*n),a=this.player.pos.clone().addScaledVector(i,9);a.y+=5.6,this.destroyAt(a,4.4,.25)}let t=this.player.pos.clone().addScaledVector(e,9);t.y+=5.6,this.hitMonster(t,11,12)},190))}fireLaser(){if(this.laserCooldown>0||!this.started)return;this.laserCooldown=.22,pu.laser(),this.player.yaw=this.camYaw+Math.PI;let e=this.aimDir(),t=this.player.pos.clone();t.y+=6.6,t.addScaledVector(e,3.8);let n=new q(new fi(.25,.25,1.6),new Ar({color:3794687}));n.position.copy(t),n.lookAt(t.clone().add(e)),this.scene.add(n),this.projectiles.push({pos:t,vel:e.multiplyScalar(70),life:2.5,kind:`laser`,mesh:n})}fireRocket(e,t){pu.rocket(1-Math.min(1,e.distanceTo(this.player.pos)/130));let n=t.clone().sub(e).normalize(),r=new q(new fi(.5,.5,1.4),new Ar({color:16742959}));r.position.copy(e),r.lookAt(t),this.scene.add(r),this.projectiles.push({pos:e.clone(),vel:n.multiplyScalar(26),life:6,kind:`rocket`,mesh:r})}updateBeam(e){let t=this.player.abilities.beam&&this.keys.has(`KeyE`)&&this.started;if(this.player.model.aiming=t,this.beamMesh.visible=t,t!==this.beamActive&&(this.beamActive=t,t?pu.beamOn():pu.beamOff()),!t)return;this.player.yaw=this.camYaw+Math.PI;let n=this.aimDir(),r=this.player.pos.clone();r.y+=7;let i=this.world.raycast(r.x,r.y,r.z,n.x,n.y,n.z,90),a=i?i.dist:90;this.beamMesh.position.copy(r).addScaledVector(n,a/2),this.beamMesh.scale.set(1,1,a),this.beamMesh.lookAt(r.clone().addScaledVector(n,a+1));let o=.8+Math.sin(this.time*40)*.2;if(this.beamMesh.material.opacity=o,this.beamTick-=e,this.beamTick<=0){this.beamTick=.12;let e=r.clone().addScaledVector(n,a);i&&this.destroyAt(e,3,.15),this.hitMonsterRay(r,n,a+8,6)}}hitMonster(e,t,n){let r=this.monster;return!r||r.dying?!1:(hu.copy(r.group.position),hu.y+=14,hu.distanceTo(e)<t+r.hitRadius?(r.takeDamage(n),this.debris.burst(e,[15],6),!0):!1)}hitMonsterRay(e,t,n,r){let i=this.monster;if(!i||i.dying)return;hu.copy(i.group.position),hu.y+=14;let a=hu.clone().sub(e),o=a.dot(t);o<0||o>n||a.sub(t.clone().multiplyScalar(o)).length()<i.hitRadius&&i.takeDamage(r)}destroyAt(e,t,n){let r=this.world.destroySphere(e.x,e.y,e.z,t);if(r.count>0){this.chunks.markDirty(r.dirty),this.debris.burst(e,r.ids,Math.min(26,6+r.count/3));let n=1-Math.min(1,e.distanceTo(this.player.pos)/110);n>.04&&this.time-this.lastBoomSound>.09&&(this.lastBoomSound=this.time,pu.explode(Math.min(1,r.count/60),n)),r.count>=6&&this.checkCollapse(e,t)}this.npcs.scare(e,34),this.cars.scare(e,34)}checkCollapse(e,t){if(this.time-this.lastCollapseScan<.25)return;this.lastCollapseScan=this.time;let n=this.world.collapseScan(e.x,e.y,e.z,t);if(!n)return;if(this.chunks.markDirty(n.dirty),this.falling.length>=5){this.debris.burst(e,n.blocks.slice(0,6).map(e=>e[3]),30);return}let r=this.world.groundHeight(e.x,e.z,40),i=uu(n.blocks,r);this.scene.add(i.mesh),this.falling.push(i)}updateFalling(e){for(let t=this.falling.length-1;t>=0;t--){let n=this.falling[t];if(!du(n,e))continue;let r=n.mesh.position.clone();r.y=n.groundY+1,this.debris.burst(r,n.sampleIds,Math.min(40,10+n.blockCount/8));let i=1-Math.min(1,r.distanceTo(this.player.pos)/130);i>.04&&pu.explode(Math.min(1,n.blockCount/150),i),this.npcs.scare(r,40),this.cars.scare(r,40),this.scene.remove(n.mesh),n.mesh.geometry.dispose(),this.falling.splice(t,1)}}updateBosses(e){if(this.monster){let t={world:this.world,playerPos:this.player.pos,destroyAt:(e,t,n)=>this.destroyAt(e,t,n),damagePlayer:e=>this.damagePlayer(e),fireRocket:(e,t)=>this.fireRocket(e,t)};this.monster.update(e,this.time,t),this.hud.setBossHP(this.monster.hp/this.monster.maxHp),this.monster.dying&&this.monster.hp<=0&&!this.monster.dead&&this.monster._rewarded!==!0&&(this.monster._rewarded=!0,this.hud.hideBoss(),this.grantReward(this.monster.reward)),this.monster.dead&&(this.scene.remove(this.monster.group),this.monster=null,this.bossTimer=this.bossPhase===`kaiju`?22:35,this.bossPhase=this.bossPhase===`kaiju`?`pre-rocket`:`endless`);return}if(this.bossTimer-=e,this.bossTimer>0)return;let t=Math.random()*Math.PI*2,n=this.player.pos.x+Math.sin(t)*100,r=this.player.pos.z+Math.cos(t)*100;if(this.bossPhase===`pre-kaiju`)this.monster=new Xl(n,r),this.bossPhase=`kaiju`,this.hud.toast(`⚠ KAIJU SIGNAL ⚠`,`GORGOSAUR is tearing through the city. Defeat it to learn the BEAM.`,5);else if(this.bossPhase===`pre-rocket`)this.monster=new Zl(n,r),this.bossPhase=`rocket`,this.hud.toast(`⚠ AIRBORNE THREAT ⚠`,`MISSILE MAW inbound. Defeat it to earn ROCKET BOOTS.`,5);else{let e=Math.random()<.5?new Xl(n,r):new Zl(n,r);e.maxHp=e.hp=Math.round(e.maxHp*1.4),e.reward=`repair`,this.monster=e,this.hud.toast(`⚠ NEW CONTACT ⚠`,e.name+` detected. Defeat it for full repairs.`,4)}this.scene.add(this.monster.group),this.hud.showBoss(this.monster.name),pu.roar()}grantReward(e){pu.jingle(),e===`beam`?(this.player.abilities.beam=!0,this.hud.unlock(`beam`,`<b>E (hold)</b> PLASMA BEAM`),this.hud.toast(`BEAM UNLOCKED`,`Hold E to fire the plasma beam`,5)):e===`boots`?(this.player.abilities.boots=!0,this.hud.unlock(`boots`,`<b>SPACE (hold)</b> ROCKET BOOTS`),this.hud.toast(`ROCKET BOOTS UNLOCKED`,`Hold SPACE in the air to fly`,5)):(this.player.heal(100),this.hud.toast(`THREAT NEUTRALIZED`,`Full repairs delivered`,4))}damagePlayer(e){this.player.damage(e),this.hud.damageFlash(),pu.thud(),this.player.hp<=0&&(this.player.respawn(),this.hud.toast(`MECHA DOWN`,`Recovered and redeployed at base`,4))}frame(){let e=Math.min(.05,this.clock.getDelta());if(this.time+=e,this.laserCooldown-=e,this.started){let t=this.keys.has(`KeyD`)||this.keys.has(`ArrowRight`),n=this.keys.has(`KeyA`)||this.keys.has(`ArrowLeft`),r=this.keys.has(`KeyS`)||this.keys.has(`ArrowDown`),i=this.keys.has(`KeyW`)||this.keys.has(`ArrowUp`),a=!!t-+!!n,o=!!i-+!!r;this.player.update(e,a,o,this.camYaw,this.keys.has(`Space`),this.keys.has(`ShiftLeft`)||this.keys.has(`ShiftRight`))}else this.player.update(e,0,0,this.camYaw,!1,!1);this.chunks.update(this.player.pos.x,this.player.pos.z);let t=[];this.monster&&!this.monster.dying&&t.push(this.monster.group.position),this.npcs.update(e,this.player.pos,t,this.time),this.cars.update(e,this.player.pos),this.updateBosses(e),this.updateBeam(e),this.updateProjectiles(e),this.updateFalling(e),this.debris.update(e),this.sky.update(e,this.player.pos,this.camera),this.hud.setHP(this.player.hp/this.player.maxHp),this.hud.update(e),this.updateCamera(),this.renderer.render(this.scene,this.camera)}updateProjectiles(e){for(let t=this.projectiles.length-1;t>=0;t--){let n=this.projectiles[t];n.life-=e,n.kind===`rocket`&&(n.vel.y-=2*e),n.pos.addScaledVector(n.vel,e),n.mesh.position.copy(n.pos);let r=!1;(this.world.solidAt(n.pos.x,n.pos.y,n.pos.z)||n.pos.y<.2)&&(r=!0),n.kind===`laser`&&this.hitMonster(n.pos,2,7)&&(r=!0),n.kind===`rocket`&&n.pos.distanceTo(this.player.pos)<7&&(r=!0,this.damagePlayer(16)),r&&this.destroyAt(n.pos,n.kind===`laser`?2.4:3.6,n.kind===`laser`?.12:.35),(r||n.life<=0)&&(this.scene.remove(n.mesh),n.mesh.geometry.dispose(),n.mesh.material.dispose(),this.projectiles.splice(t,1))}}updateCamera(){let e=this.player.pos.clone();e.y+=9.9;let t=new U(Math.sin(this.camYaw)*Math.cos(this.camPitch),Math.sin(this.camPitch),Math.cos(this.camYaw)*Math.cos(this.camPitch)),n=this.world.raycast(e.x,e.y,e.z,t.x,t.y,t.z,28),r=n?Math.max(3.5,n.dist-.8):28;this.camera.position.copy(e).addScaledVector(t,r),this.camera.lookAt(e)}};