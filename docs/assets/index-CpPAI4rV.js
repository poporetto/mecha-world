...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function to(e,t,n){let r=new Float32Array(Va),i=new V(0,1,0);return new Ti({name:`SphericalGaussianBlur`,defines:{n:Va,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:io(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function no(){return new Ti({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:io(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ro(){return new Ti({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:io(),fragmentShader:`
	...
	`}var ao=class extends Bt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ui(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var js={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Ms(e,t){let n=js[t];return n===void 0?(L(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Ns=new V;function Ps(){return U.getLuminanceCoefficients(Ns),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Ns.x.toFixed(4)}, ${Ns.y.toFixed(4)}, ${Ns.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Cs(i,i.VERTEX_SHADER,y),S=Cs(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=ks(i,x,`vertex`),n=ks(i,S,`fragment`);R(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
    ...
    `,n.addEventListener(`click`,()=>{n.remove(),e()}),this.root.appendChild(n)}setHP(e){this.hpFill.style.width=Math.max(0,e*100)+`%`,this.hpFill.style.background=e<.3?`linear-gradient(90deg,#ff3b3b,#ff9a3b)`:`linear-gradient(90deg,#26e0a8,#7fdcff)`}showBoss(e){this.bossWrap.style.display=`block`,this.bossName.textContent=`⚠ `+e+` ⚠`}setBossHP(e){this.bossFill.style.width=Math.max(0,e*100)+`%`}hideBoss(){this.bossWrap.style.display=`none`}toast(e,t,n=3.5){document.getElementById(`toast-h`).textContent=e,document.getElementById(`toast-p`).textContent=t,this.toastEl.style.opacity=`1`,this.toastTimer=n}unlock(e,t){let n=this.chips[e];n.classList.remove(`locked`),n.innerHTML=t,n.style.borderColor=`#39e6e0`}setPowerLevel(e){let t=document.getElementById(`chip-power`);t.style.display=`block`,t.style.borderColor=`#f6b1d5`,t.innerHTML=`<b>PWR</b> Lv ${e}`}damageFlash(){this.vignette.style.opacity=`1`,setTimeout(()=>this.vignette.style.opacity=`0`,250)}update(e){this.toastTimer>0&&(this.toastTimer-=e,this.toastTimer<=0&&(this.toastEl.style.opacity=`0`))}};function cd(){return new URLSearchParams(location.search).has(`touch`)?!0:window.matchMedia(`(pointer: coarse)`).matches||navigator.maxTouchPoints>0}var ld=52,ud=class{constructor(e,t){Z(this,`cb`,void 0),Z(this,`moveX`,0),Z(this,`moveZ`,0),Z(this,`jump`,!1),Z(this,`boost`,!1),Z(this,`beam`,!1),Z(this,`layer`,void 0),Z(this,`stickBase`,void 0),Z(this,`stickKnob`,void 0),Z(this,`moveId`,null),Z(this,`lookId`,null),Z(this,`moveOrigin`,{x:0,y:0}),Z(this,`lookLast`,{x:0,y:0}),Z(this,`beamBtn`,void 0),Z(this,`novaBtn`,void 0),Z(this,`stickX`,0),Z(this,`stickZ`,0),Z(this,`dpadX`,0),Z(this,`dpadZ`,0),this.cb=t,this.layer=document.createElement(`div`),this.layer.innerHTML=`
      <style>
        ...
        .tc-stick { position:absolute; width:${ld*2}px; height:${ld*2}px; border-radius:50%;
    ...
    `,this.layer.className=`tc-layer`,e.classList.add(`tc-on`),e.appendChild(this.layer),this.stickBase=this.layer.querySelector(`#tc-stick`),this.stickKnob=this.layer.querySelector(`#tc-knob`),this.beamBtn=this.layer.querySelector(`#tc-beam`),this.novaBtn=this.layer.querySelector(`#tc-nova`),this.bindButtons(),this.bindTouches()}unlock(e){(e===`beam`?this.beamBtn:this.novaBtn).classList.remove(`hidden`)}setWeapon(e){let t={saber:`⚔<br/>SABER`,rifle:`🔫<br/>RIFLE`,missiles:`🚀<br/>FIRE`}[e],n=this.layer.querySelector(`#tc-attack`);n&&(n.innerHTML=t)}bindButtons(){let e=(e,t)=>{let n=this.layer.querySelector(`#`+e);n.addEventListener(`touchstart`,e=>{e.preventDefault(),e.stopPropagation(),n.classList.add(`held`),t(!0)});let r=e=>{e.preventDefault(),e.stopPropagation(),n.classList.remove(`held`),t(!1)};n.addEventListener(`touchend`,r),n.addEventListener(`touchcancel`,r)},t=(e,t)=>{let n=this.layer.querySelector(`#`+e);n.addEventListener(`touchstart`,e=>{e.preventDefault(),e.stopPropagation(),n.classList.add(`held`),t(),setTimeout(()=>n.classList.remove(`held`),120)})};t(`tc-wheel`,()=>this.cb.onWheel()),t(`tc-nova`,()=>this.cb.onNova());let n=this.layer.querySelector(`#tc-attack`);n.addEventListener(`touchstart`,e=>{e.preventDefault(),e.stopPropagation(),n.classList.add(`held`),this.cb.onAttackDown()});let r=e=>{e.preventDefault(),e.stopPropagation(),n.classList.remove(`held`),this.cb.onAttackUp()};n.addEventListener(`touchend`,r),n.addEventListener(`touchcancel`,r),e(`tc-jump`,e=>this.jump=e),e(`tc-boost`,e=>this.boost=e),e(`tc-beam`,e=>this.beam=e),e(`tc-up`,e=>{this.dpadZ=+!!e,this.combine()}),e(`tc-down`,e=>{this.dpadZ=e?-1:0,this.combine()}),e(`tc-left`,e=>{this.dpadX=e?-1:0,this.combine()}),e(`tc-right`,e=>{this.dpadX=+!!e,this.combine()})}combine(){this.moveX=Math.max(-1,Math.min(1,this.stickX+this.dpadX)),this.moveZ=Math.max(-1,Math.min(1,this.stickZ+this.dpadZ))}bindTouches(){this.layer.addEventListener(`touchstart`,e=>{e.preventDefault();for(let t of Array.from(e.changedTouches))t.clientX<window.innerWidth*.45&&this.moveId===null?(this.moveId=t.identifier,this.moveOrigin={x:t.clientX,y:t.clientY},this.stickBase.style.left=t.clientX+`px`,this.stickBase.style.top=t.clientY+`px`,this.stickBase.style.display=`block`,this.stickKnob.style.display=`block`,this.setKnob(0,0)):this.lookId===null&&(this.lookId=t.identifier,this.lookLast={x:t.clientX,y:t.clientY})}),this.layer.addEventListener(`touchmove`,e=>{e.preventDefault();for(let t of Array.from(e.changedTouches))if(t.identifier===this.moveId){let e=t.clientX-this.moveOrigin.x,n=t.clientY-this.moveOrigin.y,r=Math.hypot(e,n);r>ld&&(e*=ld/r,n*=ld/r),this.setKnob(e,n),this.stickX=Math.abs(e)>8?e/ld:0,this.stickZ=Math.abs(n)>8?-n/ld:0,this.combine()}else t.identifier===this.lookId&&(this.cb.onLook(t.clientX-this.lookLast.x,t.clientY-this.lookLast.y),this.lookLast={x:t.clientX,y:t.clientY})});let e=e=>{for(let t of Array.from(e.changedTouches))t.identifier===this.moveId?(this.moveId=null,this.stickX=0,this.stickZ=0,this.combine(),this.stickBase.style.display=`none`,this.stickKnob.style.display=`none`):t.identifier===this.lookId&&(this.lookId=null)};this.layer.addEventListener(`touchend`,e),this.layer.addEventListener(`touchcancel`,e)}setKnob(e,t){this.stickKnob.style.left=ld+e+`px`,this.stickKnob.style.top=ld+t+`px`}},dd=new V;new class{constructor(){Z(this,`renderer`,void 0),Z(this,`scene`,new Dn),Z(this,`camera`,void 0),Z(this,`world`,new yl),Z(this,`chunks`,void 0),Z(this,`player`,void 0),Z(this,`npcs`,void 0),Z(this,`cars`,void 0),Z(this,`debris`,new Iu),Z(this,`hud`,new sd),Z(this,`touch`,null),Z(this,`keys`,new Set),Z(this,`mouseDown`,[!1,!1,!1]),Z(this,`drag`,null),Z(this,`lastCollapseScan`,0),Z(this,`camYaw`,0),Z(this,`camPitch`,.32),Z(this,`locked`,!1),Z(this,`started`,!1),Z(this,`projectiles`,[]),Z(this,`laserCooldown`,0),Z(this,`beamMesh`,void 0),Z(this,`beamTick`,0),Z(this,`beamActive`,!1),Z(this,`sky`,void 0),Z(this,`falling`,[]),Z(this,`lastBoomSound`,0),Z(this,`explosions`,new Yu),Z(this,`fire`,new yu),Z(this,`flood`,new Cu),Z(this,`repair`,void 0),Z(this,`hemi`,void 0),Z(this,`sun`,void 0),Z(this,`novaCooldown`,0),Z(this,`missileCooldown`,0),Z(this,`chargeT`,0),Z(this,`charging`,!1),Z(this,`power`,1),Z(this,`powerLevel`,1),Z(this,`weapons`,[`saber`,`rifle`,`missiles`]),Z(this,`selectedWeapon`,`saber`),Z(this,`monster`,null),Z(this,`bossIndex`,0),Z(this,`bossTimer`,14),Z(this,`clock`,new Ta),Z(this,`time`,0),this.renderer=new Wc({antialias:!0}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),document.body.appendChild(this.renderer.domElement),this.camera=new aa(65,window.innerWidth/window.innerHeight,.1,500),this.scene.background=new W(10868213),this.scene.fog=new En(12838136,110,280),this.hemi=new qi(15136511,9083526,1.25),this.sun=new ca(16774365,1.35),this.sun.position.set(.6,1,.35),this.scene.add(this.hemi,this.sun),this.sky=new ad,this.scene.add(this.sky.group),this.chunks=new El(this.world,this.scene),this.player=new Wl(this.world),this.player.respawn(),this.scene.add(this.player.model.group),this.npcs=new Ql(this.world),this.cars=new ku(this.world),this.repair=new Nu(this.world),this.scene.add(this.npcs.group,this.cars.group,this.debris.mesh,this.explosions.group,this.fire.group),this.beamMesh=new G(new K(.7,.7,1),new Mr({color:3794656,transparent:!0,opacity:.85})),this.beamMesh.visible=!1,this.scene.add(this.beamMesh),this.bindInput(),cd()&&(this.touch=new ud(document.getElementById(`hud`),{onAttackDown:()=>this.attackDown(),onAttackUp:()=>this.attackUp(),onNova:()=>this.novaPulse(),onWheel:()=>this.hud.toggleWheel(),onLook:(e,t)=>{this.camYaw-=e*.006,this.camPitch=Math.max(-.5,Math.min(1.2,this.camPitch+t*.005))}})),window.addEventListener(`resize`,()=>{this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight)}),window.__game=this,this.hud.bindWeaponWheel(e=>this.selectWeapon(e)),this.unlockEverything(),this.hud.showStart(()=>{this.started=!0,od.ensure(),od.startMusic(),this.touch||this.renderer.domElement.requestPointerLock(),this.hud.toast(`DEPLOYED`,`Explore Neo Tokyo. Something big is coming…`,4)},this.touch!==null),this.renderer.setAnimationLoop(()=>this.frame())}bindInput(){window.addEventListener(`keydown`,e=>{(e.code.startsWith(`Arrow`)||e.code===`Space`)&&e.preventDefault(),this.keys.add(e.code),e.code===`KeyF`&&this.fireLaser(),e.code===`KeyT`&&this.fireMissiles(),e.code===`KeyQ`&&this.novaPulse(),e.code===`KeyA`&&!e.repeat&&this.attackDown(),e.code===`Digit1`&&this.selectWeapon(`saber`),e.code===`Digit2`&&this.selectWeapon(`rifle`),e.code===`Digit3`&&this.selectWeapon(`missiles`),e.code===`KeyR`&&!e.repeat&&this.started&&(this.charging=!0,this.chargeT=0)}),window.addEventListener(`keyup`,e=>{this.keys.delete(e.code),e.code===`KeyR`&&this.charging&&this.releaseCharge(),e.code===`KeyA`&&this.attackUp()}),document.addEventListener(`pointerlockchange`,()=>{this.locked=document.pointerLockElement===this.renderer.domElement}),this.renderer.domElement.addEventListener(`mousedown`,e=>{this.started&&(this.mouseDown[e.button]=!0,this.locked?(e.button===0&&this.attackDown(),e.button===2&&this.fireLaser()):this.drag={x:e.clientX,y:e.clientY,sx:e.clientX,sy:e.clientY,button:e.button,moved:!1})}),window.addEventListener(`mouseup`,e=>{this.mouseDown[e.button]=!1,this.locked&&e.button===0&&this.attackUp(),this.drag&&e.button===this.drag.button&&(!this.drag.moved&&this.started&&(this.renderer.domElement.requestPointerLock(),e.button===0&&(this.attackDown(),this.attackUp()),e.button===2&&this.fireLaser()),this.drag=null)}),window.addEventListener(`contextmenu`,e=>e.preventDefault()),window.addEventListener(`mousemove`,e=>{if(this.locked)this.camYaw-=e.movementX*.0026,this.camPitch=Math.max(-.5,Math.min(1.2,this.camPitch+e.movementY*.0022));else if(this.drag){let t=e.clientX-this.drag.x,n=e.clientY-this.drag.y;Math.abs(e.clientX-this.drag.sx)+Math.abs(e.clientY-this.drag.sy)>5&&(this.drag.moved=!0),this.camYaw-=t*.005,this.camPitch=Math.max(-.5,Math.min(1.2,this.camPitch+n*.004)),this.drag.x=e.clientX,this.drag.y=e.clientY}})}aimDir(){return new V(-Math.sin(this.camYaw)*Math.cos(this.camPitch),-Math.sin(this.camPitch)*.6+.05,-Math.cos(this.camYaw)*Math.cos(this.camPitch)).normalize()}swingSaber(){this.player.model.startSwing()&&(this.player.yaw=this.camYaw+Math.PI,od.swing(),setTimeout(()=>{let e=this.aimDir();for(let t of[-.45,0,.45]){let n=Math.cos(t),r=Math.sin(t),i=new V(e.x*n-e.z*r,e.y,e.x*r+e.z*n),a=this.player.pos.clone().addScaledVector(i,9);a.y+=5.6,this.destroyAt(a,4.4,.25)}let t=this.player.pos.clone().addScaledVector(e,9);t.y+=5.6,this.hitMonster(t,11,12*this.power)},190))}fireLaser(){if(this.laserCooldown>0||!this.started)return;this.laserCooldown=.22,od.laser(),this.player.yaw=this.camYaw+Math.PI,this.player.model.group.rotation.y=this.player.yaw;let e=this.aimDir(),t=new V;this.player.model.fireRifle(t),t.addScaledVector(e,1.2);let n=new G(new K(.3,.3,2.2),new Mr({color:16756968}));n.position.copy(t),n.lookAt(t.clone().add(e)),this.scene.add(n),this.projectiles.push({pos:t,vel:e.multiplyScalar(70),life:2.5,kind:`laser`,mesh:n})}selectWeapon(e){this.selectedWeapon=e,this.hud.setWeapon(e),this.touch?.setWeapon(e)}attackDown(){this.started&&(this.selectedWeapon===`saber`?this.swingSaber():this.selectedWeapon===`missiles`?this.fireMissiles():(this.charging=!0,this.chargeT=0))}attackUp(){this.selectedWeapon===`rifle`&&this.charging&&this.releaseCharge()}fireMissiles(){if(this.missileCooldown>0||!this.started)return;this.missileCooldown=1.4,od.rocket(1),this.player.yaw=this.camYaw+Math.PI,this.player.model.group.rotation.y=this.player.yaw;let e=this.aimDir(),t=this.player.pos.clone();t.y+=7;for(let n=0;n<4;n++){let r=(n-1.5)*.28,i=Math.cos(r),a=Math.sin(r),o=new V(e.x*i-e.z*a,e.y+.15,e.x*a+e.z*i).normalize(),s=t.clone().addScaledVector(o,4),c=new G(new K(.35,.35,1.2),new Mr({color:16773280}));c.position.copy(s),c.lookAt(s.clone().add(o)),this.scene.add(c),this.projectiles.push({pos:s,vel:o.multiplyScalar(34),life:3,kind:`missile`,mesh:c,dmg:9*this.power})}}releaseCharge(){if(this.charging=!1,!this.started)return;let e=Math.min(1,this.chargeT/1.1);if(e<.25){this.fireLaser();return}od.laser(),this.player.yaw=this.camYaw+Math.PI,this.player.model.group.rotation.y=this.player.yaw;let t=this.aimDir(),n=new V;this.player.model.fireRifle(n),n.addScaledVector(t,1.5);let r=.4+e*.9,i=new G(new K(r,r,2.6+e*2),new Mr({color:12577023}));i.position.copy(n),i.lookAt(n.clone().add(t)),this.scene.add(i),this.explosions.boom(n.clone(),2+e*2),this.projectiles.push({pos:n,vel:t.multiplyScalar(85),life:2.5,kind:`charge`,mesh:i,dmg:(14+e*40)*this.power})}fireRocket(e,t){od.rocket(1-Math.min(1,e.distanceTo(this.player.pos)/130));let n=t.clone().sub(e).normalize(),r=new G(new K(.5,.5,1.4),new Mr({color:16742959}));r.position.copy(e),r.lookAt(t),this.scene.add(r),this.projectiles.push({pos:e.clone(),vel:n.multiplyScalar(26),life:6,kind:`rocket`,mesh:r})}novaPulse(){if(!this.player.abilities.nova||this.novaCooldown>0||!this.started)return;this.novaCooldown=6;let e=this.player.pos.clone();e.y+=4,this.explosions.boom(e,14),od.explode(1,1);for(let t=0;t<8;t++){let n=t/8*Math.PI*2,r=e.clone();r.x+=Math.sin(n)*10,r.z+=Math.cos(n)*10,this.destroyAt(r,4.5,.3)}this.monster&&!this.monster.dying&&this.monster.group.position.distanceTo(this.player.pos)<34&&this.monster.takeDamage(45*this.power)}zapAt(e){let t=new G(new K(1.2,60,1.2),new Mr({color:12577023,transparent:!0,opacity:.9,blending:2,depthWrite:!1}));t.position.set(e.x,e.y+30,e.z),this.scene.add(t),setTimeout(()=>{this.scene.remove(t),t.geometry.dispose(),t.material.dispose()},140),this.explosions.boom(e,5),od.zap(1-Math.min(1,e.distanceTo(this.player.pos)/130))}throwBoulder(e,t){let n=t.clone().sub(e),r=n.length();n.normalize();let i=new G(new K(2.4,2.4,2.4),new Di({color:9278366}));i.position.copy(e),i.rotation.set(Math.random()*3,Math.random()*3,0),this.scene.add(i);let a=n.multiplyScalar(Math.min(30,r*.45));a.y+=14,this.projectiles.push({pos:e.clone(),vel:a,life:8,kind:`boulder`,mesh:i}),od.rocket(1-Math.min(1,e.distanceTo(this.player.pos)/130))}updateBeam(e){let t=this.player.abilities.beam&&(this.keys.has(`KeyE`)||this.touch?.beam===!0)&&this.started;if(this.player.model.aiming=t,this.beamMesh.visible=t,t!==this.beamActive&&(this.beamActive=t,t?od.beamOn():od.beamOff()),!t)return;this.player.yaw=this.camYaw+Math.PI;let n=this.aimDir(),r=this.player.pos.clone();r.y+=7;let i=this.world.raycast(r.x,r.y,r.z,n.x,n.y,n.z,90),a=i?i.dist:90;this.beamMesh.position.copy(r).addScaledVector(n,a/2),this.beamMesh.scale.set(1,1,a),this.beamMesh.lookAt(r.clone().addScaledVector(n,a+1));let o=.8+Math.sin(this.time*40)*.2;if(this.beamMesh.material.opacity=o,this.beamTick-=e,this.beamTick<=0){this.beamTick=.12;let e=r.clone().addScaledVector(n,a);i&&this.destroyAt(e,3,.15),this.hitMonsterRay(r,n,a+8,6*this.power)}}hitMonster(e,t,n){let r=this.monster;return!r||r.dying?!1:(dd.copy(r.group.position),dd.y+=14,dd.distanceTo(e)<t+r.hitRadius?(r.takeDamage(n),this.debris.burst(e,[15],6),!0):!1)}hitMonsterRay(e,t,n,r){let i=this.monster;if(!i||i.dying)return;dd.copy(i.group.position),dd.y+=14;let a=dd.clone().sub(e),o=a.dot(t);o<0||o>n||a.sub(t.clone().multiplyScalar(o)).length()<i.hitRadius&&i.takeDamage(r)}destroyAt(e,t,n){let r=this.world.destroySphere(e.x,e.y,e.z,t);if(r.count>0){this.chunks.markDirty(r.dirty),this.repair.noteDamage(r.dirty,this.time),this.debris.burst(e,r.ids,Math.min(26,6+r.count/3)),r.count>4&&this.explosions.boom(e,Math.min(9,2+t));let n=1-Math.min(1,e.distanceTo(this.player.pos)/110);n>.04&&this.time-this.lastBoomSound>.09&&(this.lastBoomSound=this.time,od.explode(Math.min(1,r.count/60),n)),r.count>=6&&this.checkCollapse(e,t)}this.npcs.scare(e,34),this.cars.scare(e,34)}checkCollapse(e,t){if(this.time-this.lastCollapseScan<.25)return;this.lastCollapseScan=this.time;let n=this.world.collapseScan(e.x,e.y,e.z,t);if(!n&&e.y<16&&(n=this.world.foundationScan(e.x,e.z,e.y+t)),!n)return;if(this.chunks.markDirty(n.dirty),this.repair.noteDamage(n.dirty,this.time),this.falling.length>=7){this.debris.burst(e,n.blocks.slice(0,6).map(e=>e[3]),30);return}let r=this.world.groundHeight(e.x,e.z,40),i=Bu(n.blocks,r);this.scene.add(i.mesh),this.falling.push(i)}updateFalling(e){for(let t=this.falling.length-1;t>=0;t--){let n=this.falling[t];if(!Wu(n,e))continue;let r=n.mesh.position.clone();r.y=n.groundY+1,this.debris.burst(r,n.sampleIds,Math.min(40,10+n.blockCount/8)),this.explosions.boom(r,Math.min(12,4+n.blockCount/60));let i=1-Math.min(1,r.distanceTo(this.player.pos)/130);i>.04&&od.explode(Math.min(1,n.blockCount/150),i),this.npcs.scare(r,40),this.cars.scare(r,40),this.scene.remove(n.mesh),n.mesh.geometry.dispose(),this.falling.splice(t,1)}}updateBosses(e){if(this.monster){let t={world:this.world,playerPos:this.player.pos,destroyAt:(e,t,n)=>this.destroyAt(e,t,n),damagePlayer:e=>this.damagePlayer(e),fireRocket:(e,t)=>this.fireRocket(e,t),throwBoulder:(e,t)=>this.throwBoulder(e,t),zapAt:e=>this.zapAt(e),igniteAt:(e,t)=>{this.fire.igniteSphere(this.world,e.x,e.y,e.z,t)},floodAt:(e,t)=>{let n=this.flood.floodSphere(this.world,e.x,e.z,t);n.size&&this.chunks.markDirty(n)}};this.monster.update(e,this.time,t),this.hud.setBossHP(this.monster.hp/this.monster.maxHp),this.monster.dying&&this.monster.hp<=0&&!this.monster.dead&&this.monster._rewarded!==!0&&(this.monster._rewarded=!0,this.hud.hideBoss(),this.grantReward(this.monster.reward)),this.monster.dead&&(this.scene.remove(this.monster.group),this.monster instanceof ru&&this.monster.removeSegmentsFrom(this.scene),this.monster=null,this.bossTimer=25,od.setMusicIntensity(0));return}if(this.bossTimer-=e,this.bossTimer>0)return;let t=Math.random()*Math.PI*2,n=this.player.pos.x+Math.sin(t)*100,r=this.player.pos.z+Math.cos(t)*100,i=[{make:(e,t)=>new tu(e,t),toast:[`⚠ KAIJU SIGNAL ⚠`,`GORGOSAUR is tearing through the city. Defeat it to learn the BEAM.`]},{make:(e,t)=>new nu(e,t),toast:[`⚠ AIRBORNE THREAT ⚠`,`MISSILE MAW inbound. Defeat it to earn ROCKET BOOTS.`]},{make:(e,t)=>new ru(e,t),toast:[`⚠ SEISMIC WEAVE ⚠`,`VOLT SERPENT surfacing. Defeat it to learn the NOVA PULSE.`]},{make:(e,t)=>new iu(e,t),toast:[`⚠ HEAVY FOOTFALLS ⚠`,`IRON COLOSSUS approaching. Defeat it to earn the AEGIS SHIELD.`]},{make:(e,t)=>new au(e,t),toast:[`⚠ SHADOW OVERHEAD ⚠`,`SKY REAVER circling above. Watch for its strafing dives.`]},{make:(e,t)=>new ou(e,t),toast:[`⚠ RAPID MOVEMENT ⚠`,`CRIMSON MANTIS closing fast. Keep your distance from its scythes.`]},{make:(e,t)=>new su(e,t),toast:[`⚠ MOLTEN MASS ⚠`,`MAGMA GOLEM erupting. Dodge its ground slams.`]},{make:(e,t)=>new cu(e,t),toast:[`⚠ TREMORS ⚠`,`DEEP MAW burrowing below. It strikes from underground — keep moving.`]},{make:(e,t)=>new lu(e,t),toast:[`⚠ FIRESTORM ⚠`,`CINDER WYRM torching the district. Put it down before the city burns.`]},{make:(e,t)=>new uu(e,t),toast:[`⚠ FLOOD WARNING ⚠`,`TIDE LEVIATHAN surfacing. Its aqua blaster drowns the streets.`]}];if(this.bossIndex<i.length){let e=i[this.bossIndex++];this.monster=e.make(n,r),this.hud.toast(e.toast[0],e.toast[1],5)}else{let e=[tu,nu,ru,iu,au,ou,su,cu,lu,uu],t=e[Math.floor(Math.random()*e.length)],i=new t(n,r);i.maxHp=i.hp=Math.round(i.maxHp*(1.3+this.powerLevel*.2)),i.reward=`repair`,this.monster=i,this.hud.toast(`⚠ NEW CONTACT ⚠`,i.name+` detected. Defeat it for repairs and a power boost.`,4)}this.monster instanceof ru&&this.monster.addSegmentsTo(this.scene),this.scene.add(this.monster.group),this.hud.showBoss(this.monster.name),od.roar(),od.setMusicIntensity(1)}unlockEverything(){this.player.abilities.beam=!0,this.player.abilities.boots=!0,this.player.abilities.nova=!0,this.player.abilities.shield=!0,this.hud.unlock(`beam`,`<b>E (hold)</b> PLASMA BEAM`),this.hud.unlock(`boots`,`<b>SPACE (hold)</b> ROCKET BOOTS`),this.hud.unlock(`nova`,`<b>Q</b> NOVA PULSE`),this.hud.unlock(`shield`,`AEGIS SHIELD 50%`),this.touch?.unlock(`beam`),this.touch?.unlock(`nova`),this.selectWeapon(`saber`)}grantReward(e){od.jingle(),e===`beam`?(this.player.abilities.beam=!0,this.touch?.unlock(`beam`),this.hud.unlock(`beam`,`<b>E (hold)</b> PLASMA BEAM`),this.hud.toast(`BEAM UNLOCKED`,`Hold E to fire the plasma beam`,5)):e===`boots`?(this.player.abilities.boots=!0,this.hud.unlock(`boots`,`<b>SPACE (hold)</b> ROCKET BOOTS`),this.hud.toast(`ROCKET BOOTS UNLOCKED`,`Hold SPACE in the air to fly`,5)):e===`nova`?(this.player.abilities.nova=!0,this.touch?.unlock(`nova`),this.hud.unlock(`nova`,`<b>Q</b> NOVA PULSE`),this.hud.toast(`NOVA PULSE UNLOCKED`,`Press Q for a devastating shockwave`,5)):e===`shield`?(this.player.abilities.shield=!0,this.hud.unlock(`shield`,`AEGIS SHIELD 50%`),this.hud.toast(`AEGIS SHIELD ONLINE`,`All damage is halved`,5)):(this.player.heal(100),this.powerLevel++,this.power=1+(this.powerLevel-1)*.25,this.hud.setPowerLevel(this.powerLevel),this.hud.toast(`POWER LEVEL `+this.powerLevel,`Weapons upgraded · full repairs delivered`,4))}damagePlayer(e){if(this.player.abilities.shield){e*=.5;let t=this.player.pos.clone();t.y+=5,this.explosions.boom(t,3)}this.player.damage(e),this.hud.damageFlash(),od.thud(),this.player.hp<=0&&(this.player.respawn(),this.hud.toast(`MECHA DOWN`,`Recovered and redeployed at base`,4))}frame(){let e=Math.min(.05,this.clock.getDelta());if(this.time+=e,this.laserCooldown-=e,this.novaCooldown-=e,this.missileCooldown-=e,this.charging&&(this.chargeT+=e),this.started){let t=this.keys.has(`KeyD`)||this.keys.has(`ArrowRight`),n=this.keys.has(`ArrowLeft`),r=this.keys.has(`KeyS`)||this.keys.has(`ArrowDown`),i=this.keys.has(`KeyW`)||this.keys.has(`ArrowUp`),a=!!t-+!!n,o=!!i-+!!r,s=this.keys.has(`Space`),c=this.keys.has(`ShiftLeft`)||this.keys.has(`ShiftRight`);this.touch&&(a+=this.touch.moveX,o+=this.touch.moveZ,s=s||this.touch.jump,c=c||this.touch.boost),this.player.update(e,a,o,this.camYaw,s,c)}else this.player.update(e,0,0,this.camYaw,!1,!1);this.chunks.update(this.player.pos.x,this.player.pos.z);let t=[];this.monster&&!this.monster.dying&&t.push(this.monster.group.position),this.npcs.update(e,this.player.pos,t,this.time),this.cars.update(e,this.player.pos),this.updateBosses(e),this.updateBeam(e),this.updateProjectiles(e),this.updateFalling(e),this.debris.update(e),this.explosions.update(e),this.updateFire(e);let n=this.flood.update(e,this.world);n&&this.chunks.markDirty(n.dirty);let r=this.repair.update(e,this.time,this.player.pos.x,this.player.pos.z);if(r){this.chunks.markDirty(r.dirty);for(let e of r.startedSites)this.npcs.spawnWorkers(e.x,e.z);for(let e=0;e<Math.min(3,r.restored.length);e++){let e=r.restored[Math.floor(Math.random()*r.restored.length)];this.debris.burst(new V(e.x+.5,e.y+1,e.z+.5),[18],2)}}let i=this.sky.update(e,this.time,this.player.pos,this.camera);this.scene.background.copy(i.skyColor),this.scene.fog.color.copy(i.fogColor),this.sun.intensity=i.sunIntensity,this.sun.position.copy(i.sunDir),this.hemi.intensity=i.hemiIntensity,this.hud.setHP(this.player.hp/this.player.maxHp),this.hud.update(e),this.updateCamera(),this.renderer.render(this.scene,this.camera)}updateFire(e){let t=this.fire.update(e,this.world);if(!t)return;t.dirty.size&&(this.chunks.markDirty(t.dirty),this.repair.noteDamage(t.dirty,this.time));let n=null;for(let e of t.destroyed)Math.random()<.5&&this.debris.burst(new V(e[0]+.5,e[1]+.5,e[2]+.5),[12],3),(!n||e[1]<n[1])&&(n=e);n&&n[1]<10&&(dd.set(n[0]+.5,n[1]+.5,n[2]+.5),this.checkCollapse(dd,5))}updateProjectiles(e){let t=e=>e===`laser`||e===`missile`||e===`charge`;for(let n=this.projectiles.length-1;n>=0;n--){let r=this.projectiles[n];if(r.life-=e,r.kind===`rocket`&&(r.vel.y-=2*e),r.kind===`boulder`&&(r.vel.y-=16*e,r.mesh.rotation.x+=e*3,r.mesh.rotation.z+=e*2),r.kind===`missile`){let t=this.monster;if(t&&!t.dying){dd.copy(t.group.position),dd.y+=14,dd.sub(r.pos).normalize();let n=r.vel.length();r.vel.lerp(dd.multiplyScalar(n),Math.min(1,e*2.5)),r.vel.setLength(Math.min(52,n+40*e))}r.mesh.lookAt(r.pos.clone().add(r.vel))}r.pos.addScaledVector(r.vel,e),r.mesh.position.copy(r.pos);let i=!1;if((this.world.solidAt(r.pos.x,r.pos.y,r.pos.z)||r.pos.y<.2)&&(i=!0),t(r.kind)){let e=r.kind===`charge`?4:2;this.hitMonster(r.pos,e,(r.dmg??7)*(r.kind===`laser`?this.power:1))&&(i=!0)}else r.pos.distanceTo(this.player.pos)<(r.kind===`boulder`?8:7)&&(i=!0,this.damagePlayer(r.kind===`boulder`?22:16));if(i){let e=r.kind===`charge`?4.5:r.kind===`laser`?2.4:r.kind===`missile`?3:r.kind===`boulder`?5:3.6;this.destroyAt(r.pos,e,.2)}(i||r.life<=0)&&(this.scene.remove(r.mesh),r.mesh.geometry.dispose(),r.mesh.material.dispose(),this.projectiles.splice(n,1))}}updateCamera(){let e=this.player.pos.clone();e.y+=9.9;let t=new V(Math.sin(this.camYaw)*Math.cos(this.camPitch),Math.sin(this.camPitch),Math.cos(this.camYaw)*Math.cos(this.camPitch)),n=this.world.raycast(e.x,e.y,e.z,t.x,t.y,t.z,28),r=n?Math.max(3.5,n.dist-.8):28;this.camera.position.copy(e).addScaledVector(t,r),this.camera.lookAt(e)}};