...
void main() {
    ...
    `,this.layer.className=`tc-layer`,e.classList.add(`tc-on`),e.appendChild(this.layer),this.stickBase=this.layer.querySelector(`#tc-stick`),this.stickKnob=this.layer.querySelector(`#tc-knob`),this.beamBtn=this.layer.querySelector(`#tc-beam`),this.novaBtn=this.layer.querySelector(`#tc-nova`),this.quakeBtn=this.layer.querySelector(`#tc-quake`),this.bindButtons(),this.bindTouches()}unlock(e){(e===`beam`?this.beamBtn:e===`nova`?this.novaBtn:this.quakeBtn)?.classList.remove(`hidden`)}unlockWeapon(e){}setWeapon(e){let t=gd.find(t=>t.id===e),n=this.layer.querySelector(`#tc-attack`);n&&(n.innerHTML=t.icon+`<br/>`+t.label)}bindButtons(){let e=(e,t)=>{let n=this.layer.querySelector(`#`+e);n.addEventListener(`touchstart`,e=>{e.preventDefault(),e.stopPropagation(),n.classList.add(`held`),t(!0)});let r=e=>{e.preventDefault(),e.stopPropagation(),n.classList.remove(`held`),t(!1)};n.addEventListener(`touchend`,r),n.addEventListener(`touchcancel`,r)},t=(e,t)=>{let n=this.layer.querySelector(`#`+e);n.addEventListener(`touchstart`,e=>{e.preventDefault(),e.stopPropagation(),n.classList.add(`held`),t(),setTimeout(()=>n.classList.remove(`held`),120)})};t(`tc-wheel`,()=>this.cb.onWheel()),t(`tc-nova`,()=>this.cb.onNova()),t(`tc-quake`,()=>this.cb.onQuake());let n=this.layer.querySelector(`#tc-attack`);n.addEventListener(`touchstart`,e=>{e.preventDefault(),e.stopPropagation(),n.classList.add(`held`),this.cb.onAttackDown()});let r=e=>{e.preventDefault(),e.stopPropagation(),n.classList.remove(`held`),this.cb.onAttackUp()};n.addEventListener(`touchend`,r),n.addEventListener(`touchcancel`,r),e(`tc-jump`,e=>this.jump=e),e(`tc-boost`,e=>this.boost=e),e(`tc-beam`,e=>this.beam=e),e(`tc-up`,e=>{this.dpadZ=+!!e,this.combine()}),e(`tc-down`,e=>{this.dpadZ=e?-1:0,this.combine()}),e(`tc-left`,e=>{this.dpadX=e?-1:0,this.combine()}),e(`tc-right`,e=>{this.dpadX=+!!e,this.combine()})}combine(){this.moveX=Math.max(-1,Math.min(1,this.stickX+this.dpadX)),this.moveZ=Math.max(-1,Math.min(1,this.stickZ+this.dpadZ))}bindTouches(){this.layer.addEventListener(`touchstart`,e=>{e.preventDefault();for(let t of Array.from(e.changedTouches))t.clientX<window.innerWidth*.45&&this.moveId===null?(this.moveId=t.identifier,this.moveOrigin={x:t.clientX,y:t.clientY},this.stickBase.style.left=t.clientX+`px`,this.stickBase.style.top=t.clientY+`px`,this.stickBase.style.display=`block`,this.stickKnob.style.display=`block`,this.setKnob(0,0)):this.lookId===null&&(this.lookId=t.identifier,this.lookLast={x:t.clientX,y:t.clientY})}),this.layer.addEventListener(`touchmove`,e=>{e.preventDefault();for(let t of Array.from(e.changedTouches))if(t.identifier===this.moveId){let e=t.clientX-this.moveOrigin.x,n=t.clientY-this.moveOrigin.y,r=Math.hypot(e,n);r>yd&&(e*=yd/r,n*=yd/r),this.setKnob(e,n),this.stickX=Math.abs(e)>8?e/yd:0,this.stickZ=Math.abs(n)>8?-n/yd:0,this.combine()}else t.identifier===this.lookId&&(this.cb.onLook(t.clientX-this.lookLast.x,t.clientY-this.lookLast.y),this.lookLast={x:t.clientX,y:t.clientY})});let e=e=>{for(let t of Array.from(e.changedTouches))t.identifier===this.moveId?(this.moveId=null,this.stickX=0,this.stickZ=0,this.combine(),this.stickBase.style.display=`none`,this.stickKnob.style.display=`none`):t.identifier===this.lookId&&(this.lookId=null)};this.layer.addEventListener(`touchend`,e),this.layer.addEventListener(`touchcancel`,e)}setKnob(e,t){this.stickKnob.style.left=yd+e+`px`,this.stickKnob.style.top=yd+t+`px`}},xd=new V;new class{constructor(){Z(this,`renderer`,void 0),Z(this,`scene`,new Dn),Z(this,`camera`,void 0),Z(this,`world`,new bl),Z(this,`chunks`,void 0),Z(this,`player`,void 0),Z(this,`npcs`,void 0),Z(this,`cars`,void 0),Z(this,`debris`,new Wu),Z(this,`planes`,new Lu),Z(this,`ridingPlane`,null),Z(this,`hud`,new _d),Z(this,`touch`,null),Z(this,`keys`,new Set),Z(this,`mouseDown`,[!1,!1,!1]),Z(this,`drag`,null),Z(this,`lastCollapseScan`,0),Z(this,`camYaw`,0),Z(this,`camPitch`,.32),Z(this,`locked`,!1),Z(this,`started`,!1),Z(this,`projectiles`,[]),Z(this,`laserCooldown`,0),Z(this,`beamMesh`,void 0),Z(this,`beamTick`,0),Z(this,`beamActive`,!1),Z(this,`sky`,void 0),Z(this,`falling`,[]),Z(this,`lastBoomSound`,0),Z(this,`explosions`,new id),Z(this,`fire`,new Su),Z(this,`flood`,new Eu),Z(this,`repair`,void 0),Z(this,`hemi`,void 0),Z(this,`sun`,void 0),Z(this,`novaCooldown`,0),Z(this,`quakeCooldown`,0),Z(this,`missileCooldown`,0),Z(this,`chargeT`,0),Z(this,`charging`,!1),Z(this,`power`,1),Z(this,`powerLevel`,1),Z(this,`unlockedWeapons`,new Set([`saber`,`rifle`,`missiles`])),Z(this,`selectedWeapon`,`saber`),Z(this,`railCooldown`,0),Z(this,`vulcanCooldown`,0),Z(this,`streamCooldown`,0),Z(this,`attackHeld`,!1),Z(this,`monster`,null),Z(this,`bossIndex`,0),Z(this,`bossTimer`,14),Z(this,`wave`,0),Z(this,`score`,0),Z(this,`combo`,1),Z(this,`comboTimer`,0),Z(this,`shake`,0),Z(this,`slowmo`,0),Z(this,`lockOn`,!1),Z(this,`dashT`,0),Z(this,`comboWindow`,0),Z(this,`comboStep`,0),Z(this,`clock`,new Ea),Z(this,`time`,0),this.renderer=new Gc({antialias:!0}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),document.body.appendChild(this.renderer.domElement),this.camera=new oa(65,window.innerWidth/window.innerHeight,.1,500),this.scene.background=new W(10868213),this.scene.fog=new En(12838136,110,280),this.hemi=new Ji(15136511,9083526,1.25),this.sun=new la(16774365,1.35),this.sun.position.set(.6,1,.35),this.scene.add(this.hemi,this.sun),this.sky=new md,this.scene.add(this.sky.group),this.chunks=new Dl(this.world,this.scene),this.player=new ql(this.world),this.player.respawn(),this.scene.add(this.player.model.group),this.npcs=new tu(this.world),this.cars=new Mu(this.world),this.repair=new Vu(this.world),this.scene.add(this.npcs.group,this.cars.group,this.debris.mesh,this.explosions.group,this.fire.group),this.scene.add(this.planes.group),this.beamMesh=new G(new K(.7,.7,1),new Mr({color:3794656,transparent:!0,opacity:.85})),this.beamMesh.visible=!1,this.scene.add(this.beamMesh),this.bindInput(),vd()&&(this.touch=new bd(document.getElementById(`hud`),{onAttackDown:()=>this.attackDown(),onAttackUp:()=>this.attackUp(),onNova:()=>this.novaPulse(),onQuake:()=>this.quakeSlam(),onWheel:()=>this.hud.toggleWheel(),onLook:(e,t)=>{this.camYaw-=e*.006,this.camPitch=Math.max(-.5,Math.min(1.2,this.camPitch+t*.005))}})),window.addEventListener(`resize`,()=>{this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight)}),window.__game=this,this.hud.bindWeaponWheel(e=>this.selectWeapon(e));let e=new URLSearchParams(location.search);e.has(`debug`)||e.has(`all`)?this.unlockEverything():this.selectWeapon(`saber`),this.hud.showStart(()=>{this.started=!0,hd.ensure(),hd.startMusic(),this.touch||this.renderer.domElement.requestPointerLock(),this.hud.toast(`DEPLOYED`,`Explore Neo Tokyo. Something big is coming…`,4)},this.touch!==null),this.renderer.setAnimationLoop(()=>this.frame())}bindInput(){window.addEventListener(`keydown`,e=>{if((e.code.startsWith(`Arrow`)||e.code===`Space`)&&e.preventDefault(),this.keys.add(e.code),e.code===`KeyF`&&this.fireLaser(),e.code===`KeyT`&&this.fireMissiles(),e.code===`KeyQ`&&this.novaPulse(),e.code===`KeyC`&&!e.repeat&&this.dash(),(e.code===`KeyL`||e.code===`Tab`)&&!e.repeat&&(e.preventDefault(),this.toggleLockOn()),e.code===`KeyA`&&!e.repeat&&this.attackDown(),e.code.startsWith(`Digit`)){let t=Number(e.code.slice(5))-1;t>=0&&t<gd.length&&this.selectWeapon(gd[t].id)}e.code===`KeyG`&&this.quakeSlam(),e.code===`KeyR`&&!e.repeat&&this.started&&(this.charging=!0,this.chargeT=0)}),window.addEventListener(`keyup`,e=>{this.keys.delete(e.code),e.code===`KeyR`&&this.charging&&this.releaseCharge(),e.code===`KeyA`&&this.attackUp()}),document.addEventListener(`pointerlockchange`,()=>{this.locked=document.pointerLockElement===this.renderer.domElement}),this.renderer.domElement.addEventListener(`mousedown`,e=>{if(this.started){if(this.mouseDown[e.button]=!0,e.button===1){this.toggleLockOn();return}this.locked?(e.button===0&&this.attackDown(),e.button===2&&this.fireLaser()):this.drag={x:e.clientX,y:e.clientY,sx:e.clientX,sy:e.clientY,button:e.button,moved:!1}}}),window.addEventListener(`mouseup`,e=>{this.mouseDown[e.button]=!1,this.locked&&e.button===0&&this.attackUp(),this.drag&&e.button===this.drag.button&&(!this.drag.moved&&this.started&&(this.renderer.domElement.requestPointerLock(),e.button===0&&(this.attackDown(),this.attackUp()),e.button===2&&this.fireLaser()),this.drag=null)}),window.addEventListener(`contextmenu`,e=>e.preventDefault()),window.addEventListener(`mousemove`,e=>{if(this.locked)this.camYaw-=e.movementX*.0026,this.camPitch=Math.max(-.5,Math.min(1.2,this.camPitch+e.movementY*.0022));else if(this.drag){let t=e.clientX-this.drag.x,n=e.clientY-this.drag.y;Math.abs(e.clientX-this.drag.sx)+Math.abs(e.clientY-this.drag.sy)>5&&(this.drag.moved=!0),this.camYaw-=t*.005,this.camPitch=Math.max(-.5,Math.min(1.2,this.camPitch+n*.004)),this.drag.x=e.clientX,this.drag.y=e.clientY}})}aimDir(){if(this.lockOn&&this.monster&&!this.monster.dying){xd.copy(this.monster.group.position),xd.y+=14;let e=this.player.pos.clone();return e.y+=6.6,xd.sub(e).normalize()}return new V(-Math.sin(this.camYaw)*Math.cos(this.camPitch),-Math.sin(this.camPitch)*.6+.05,-Math.cos(this.camYaw)*Math.cos(this.camPitch)).normalize()}toggleLockOn(){!this.lockOn&&(!this.monster||this.monster.dying)||(this.lockOn=!this.lockOn,this.hud.setLockOn(this.lockOn))}dash(){if(this.dashT>0||!this.started)return;this.dashT=.9;let e=this.keys.has(`KeyD`)||this.keys.has(`ArrowRight`),t=this.keys.has(`ArrowLeft`),n=this.keys.has(`KeyS`)||this.keys.has(`ArrowDown`),r=this.keys.has(`KeyW`)||this.keys.has(`ArrowUp`),i=!!e-+!!t,a=!!r-+!!n;this.touch&&(i+=this.touch.moveX,a+=this.touch.moveZ);let o;if(i!==0||a!==0){let e=Math.hypot(i,a),t=i/e,n=a/e,r=Math.sin(this.camYaw),s=Math.cos(this.camYaw);o=new V(t*s-n*r,0,t*-r-n*s)}else o=new V(Math.sin(this.player.yaw),0,Math.cos(this.player.yaw));this.player.dash(o),this.explosions.boom(this.player.pos.clone().setY(this.player.pos.y+3),3),hd.rocket(.6)}swingSaber(){if(!this.player.model.startSwing())return;this.comboWindow>0?this.comboStep=(this.comboStep+1)%3:this.comboStep=0,this.comboWindow=this.player.abilities.blades?1:.7;let e=this.comboStep;if(this.lockOn&&this.monster&&!this.monster.dying){let e=this.monster.group.position;this.player.yaw=Math.atan2(e.x-this.player.pos.x,e.z-this.player.pos.z)}else this.player.yaw=this.camYaw+Math.PI;hd.swing(),setTimeout(()=>{let t=this.aimDir(),n=e===2,r=n?[-.7,-.35,0,.35,.7]:[-.45,0,.45],i=n?11:9;for(let e of r){let r=Math.cos(e),a=Math.sin(e),o=new V(t.x*r-t.z*a,t.y,t.x*a+t.z*r),s=this.player.pos.clone().addScaledVector(o,i);s.y+=5.6,this.destroyAt(s,n?5.2:4.4,n?.5:.25)}let a=this.player.pos.clone().addScaledVector(t,i);a.y+=5.6;let o=this.player.abilities.blades?1.6:1,s=(n?26:12+e*4)*this.power*o;this.hitMonster(a,n?14:11,s)&&n&&(this.shake=Math.max(this.shake,.8))},190)}fireLaser(){if(this.laserCooldown>0||!this.started)return;this.laserCooldown=.22,hd.laser(),this.player.yaw=this.camYaw+Math.PI,this.player.model.group.rotation.y=this.player.yaw;let e=this.aimDir(),t=new V;this.player.model.fireRifle(t),t.addScaledVector(e,1.2);let n=new G(new K(.3,.3,2.2),new Mr({color:16756968}));n.position.copy(t),n.lookAt(t.clone().add(e)),this.scene.add(n),this.projectiles.push({pos:t,vel:e.multiplyScalar(70),life:2.5,kind:`laser`,mesh:n})}selectWeapon(e){this.unlockedWeapons.has(e)&&(this.selectedWeapon=e,this.hud.setWeapon(e),this.touch?.setWeapon(e))}attackDown(){if(!this.started)return;let e=this.selectedWeapon;e===`saber`?this.swingSaber():e===`missiles`?this.fireMissiles():e===`railgun`?this.fireRailgun():e===`flamer`||e===`aqua`||e===`vulcan`?this.attackHeld=!0:(this.charging=!0,this.chargeT=0)}attackUp(){this.attackHeld=!1,this.selectedWeapon===`rifle`&&this.charging&&this.releaseCharge()}fireMissiles(){if(this.missileCooldown>0||!this.started)return;this.missileCooldown=1.4,hd.rocket(1),this.player.yaw=this.camYaw+Math.PI,this.player.model.group.rotation.y=this.player.yaw;let e=this.aimDir(),t=this.player.pos.clone();t.y+=7;for(let n=0;n<4;n++){let r=(n-1.5)*.28,i=Math.cos(r),a=Math.sin(r),o=new V(e.x*i-e.z*a,e.y+.15,e.x*a+e.z*i).normalize(),s=t.clone().addScaledVector(o,4),c=new G(new K(.35,.35,1.2),new Mr({color:16773280}));c.position.copy(s),c.lookAt(s.clone().add(o)),this.scene.add(c),this.projectiles.push({pos:s,vel:o.multiplyScalar(34),life:3,kind:`missile`,mesh:c,dmg:9*this.power})}}fireRailgun(){if(this.railCooldown>0||!this.started)return;this.railCooldown=1.6,hd.zap(1),this.player.yaw=this.camYaw+Math.PI,this.player.model.group.rotation.y=this.player.yaw;let e=this.aimDir(),t=new V;this.player.model.fireRifle(t);let n=new G(new K(1.1,1.1,150),new Mr({color:12577023,transparent:!0,opacity:.9,blending:2,depthWrite:!1}));n.position.copy(t).addScaledVector(e,150/2),n.lookAt(t.clone().addScaledVector(e,150)),this.scene.add(n);let r={t:.32},i=()=>{r.t-=.016,n.material.opacity=Math.max(0,r.t/.32)*.9,r.t>0?requestAnimationFrame(i):(this.scene.remove(n),n.geometry.dispose(),n.material.dispose())};i();for(let n=6;n<150;n+=5){let r=t.clone().addScaledVector(e,n);if(r.y<.5)break;this.destroyAt(r,3.4,.3)}this.hitMonsterRay(t,e,150,55*this.power),this.shake=Math.max(this.shake,.7)}fireVulcan(){if(this.vulcanCooldown>0||!this.started)return;this.vulcanCooldown=.08,this.player.yaw=this.camYaw+Math.PI,this.player.model.group.rotation.y=this.player.yaw;let e=this.aimDir();e.x+=(Math.random()-.5)*.06,e.y+=(Math.random()-.5)*.04,e.z+=(Math.random()-.5)*.06,e.normalize();let t=this.player.pos.clone();t.y+=9.6,t.addScaledVector(e,2);let n=new G(new K(.18,.18,1.1),new Mr({color:16774064}));n.position.copy(t),n.lookAt(t.clone().add(e)),this.scene.add(n),this.projectiles.push({pos:t,vel:e.multiplyScalar(95),life:1.2,kind:`laser`,mesh:n,dmg:3*this.power}),Math.random()<.35&&hd.laser()}updateStreams(e){let t=this.selectedWeapon,n=this.attackHeld&&(t===`flamer`||t===`aqua`);if(this.player.model.aiming=n||this.player.model.aiming,this.attackHeld&&t===`vulcan`&&this.fireVulcan(),!n||(this.streamCooldown-=e,this.streamCooldown>0))return;this.streamCooldown=.09,this.player.yaw=this.camYaw+Math.PI;let r=this.aimDir(),i=this.player.pos.clone();i.y+=7;let a=this.world.raycast(i.x,i.y,i.z,r.x,r.y,r.z,46),o=a?a.dist:46,s=i.clone().addScaledVector(r,o);if(t===`flamer`)this.fire.igniteSphere(this.world,s.x,s.y,s.z,4),this.explosions.boom(s,3),this.hitMonsterRay(i,r,o+6,5*this.power),hd.rocket(.5);else{let e=this.flood.floodSphere(this.world,s.x,s.z,5);this.chunks.markDirty(e),this.hitMonsterRay(i,r,o+6,4*this.power),this.fire.douse(s.x,s.z,6),hd.rocket(.35)}}quakeSlam(){if(!this.player.abilities.quake||this.quakeCooldown>0||!this.started)return;this.quakeCooldown=7;let e=this.player.pos.clone();e.y+=1,hd.explode(1,1),this.shake=Math.max(this.shake,1.1),this.explosions.boom(e,16);for(let[t,n]of[[11,10],[19,14]])for(let r=0;r<n;r++){let i=r/n*Math.PI*2,a=e.clone();a.x+=Math.sin(i)*t,a.z+=Math.cos(i)*t,a.y=this.world.groundHeight(a.x,a.z,40)+1,this.destroyAt(a,5,.4)}this.monster&&!this.monster.dying&&this.monster.group.position.distanceTo(this.player.pos)<40&&this.monster.takeDamage(60*this.power)}releaseCharge(){if(this.charging=!1,!this.started)return;let e=Math.min(1,this.chargeT/1.1);if(e<.25){this.fireLaser();return}hd.laser(),this.player.yaw=this.camYaw+Math.PI,this.player.model.group.rotation.y=this.player.yaw;let t=this.aimDir(),n=new V;this.player.model.fireRifle(n),n.addScaledVector(t,1.5);let r=.4+e*.9,i=new G(new K(r,r,2.6+e*2),new Mr({color:12577023}));i.position.copy(n),i.lookAt(n.clone().add(t)),this.scene.add(i),this.explosions.boom(n.clone(),2+e*2),this.projectiles.push({pos:n,vel:t.multiplyScalar(85),life:2.5,kind:`charge`,mesh:i,dmg:(14+e*40)*this.power})}fireRocket(e,t){hd.rocket(1-Math.min(1,e.distanceTo(this.player.pos)/130));let n=t.clone().sub(e).normalize(),r=new G(new K(.5,.5,1.4),new Mr({color:16742959}));r.position.copy(e),r.lookAt(t),this.scene.add(r),this.projectiles.push({pos:e.clone(),vel:n.multiplyScalar(26),life:6,kind:`rocket`,mesh:r})}novaPulse(){if(!this.player.abilities.nova||this.novaCooldown>0||!this.started)return;this.novaCooldown=6;let e=this.player.pos.clone();e.y+=4,this.explosions.boom(e,14),hd.explode(1,1);for(let t=0;t<8;t++){let n=t/8*Math.PI*2,r=e.clone();r.x+=Math.sin(n)*10,r.z+=Math.cos(n)*10,this.destroyAt(r,4.5,.3)}this.monster&&!this.monster.dying&&this.monster.group.position.distanceTo(this.player.pos)<34&&this.monster.takeDamage(45*this.power)}zapAt(e){let t=new G(new K(1.2,60,1.2),new Mr({color:12577023,transparent:!0,opacity:.9,blending:2,depthWrite:!1}));t.position.set(e.x,e.y+30,e.z),this.scene.add(t),setTimeout(()=>{this.scene.remove(t),t.geometry.dispose(),t.material.dispose()},140),this.explosions.boom(e,5),hd.zap(1-Math.min(1,e.distanceTo(this.player.pos)/130))}throwBoulder(e,t){let n=t.clone().sub(e),r=n.length();n.normalize();let i=new G(new K(2.4,2.4,2.4),new Oi({color:9278366}));i.position.copy(e),i.rotation.set(Math.random()*3,Math.random()*3,0),this.scene.add(i);let a=n.multiplyScalar(Math.min(30,r*.45));a.y+=14,this.projectiles.push({pos:e.clone(),vel:a,life:8,kind:`boulder`,mesh:i}),hd.rocket(1-Math.min(1,e.distanceTo(this.player.pos)/130))}updateBeam(e){let t=this.player.abilities.beam&&(this.keys.has(`KeyE`)||this.touch?.beam===!0)&&this.started;if(this.player.model.aiming=t,this.beamMesh.visible=t,t!==this.beamActive&&(this.beamActive=t,t?hd.beamOn():hd.beamOff()),!t)return;this.player.yaw=this.camYaw+Math.PI;let n=this.aimDir(),r=this.player.pos.clone();r.y+=7;let i=this.world.raycast(r.x,r.y,r.z,n.x,n.y,n.z,90),a=i?i.dist:90;this.beamMesh.position.copy(r).addScaledVector(n,a/2),this.beamMesh.scale.set(1,1,a),this.beamMesh.lookAt(r.clone().addScaledVector(n,a+1));let o=.8+Math.sin(this.time*40)*.2;if(this.beamMesh.material.opacity=o,this.beamTick-=e,this.beamTick<=0){this.beamTick=.12;let e=r.clone().addScaledVector(n,a);i&&this.destroyAt(e,3,.15),this.hitMonsterRay(r,n,a+8,6*this.power)}}hitMonster(e,t,n){let r=this.monster;return!r||r.dying?!1:(xd.copy(r.group.position),xd.y+=14,xd.distanceTo(e)<t+r.hitRadius?(r.takeDamage(n),this.debris.burst(e,[15],6),this.addScore(Math.round(n*2),!0),this.hud.popDamage(n),!0):!1)}hitMonsterRay(e,t,n,r){let i=this.monster;if(!i||i.dying)return;xd.copy(i.group.position),xd.y+=14;let a=xd.clone().sub(e),o=a.dot(t);o<0||o>n||a.sub(t.clone().multiplyScalar(o)).length()<i.hitRadius&&(i.takeDamage(r),this.addScore(Math.round(r*2),!0),this.hud.popDamage(r))}addScore(e,t=!1){t?(this.combo=Math.min(9,this.combo+1),this.comboTimer=3.5):this.comboTimer<=0&&(this.combo=1),this.score+=Math.round(e*this.combo),this.hud.setScore(this.score,this.combo)}destroyAt(e,t,n){let r=this.world.destroySphere(e.x,e.y,e.z,t);if(r.count>0){this.score+=r.count,this.hud.setScore(this.score,this.combo),n>.25&&(this.shake=Math.max(this.shake,Math.min(1.4,n))),this.chunks.markDirty(r.dirty),this.repair.noteDamage(r.dirty,this.time),this.debris.burst(e,r.ids,Math.min(26,6+r.count/3)),r.count>4&&this.explosions.boom(e,Math.min(9,2+t));let i=1-Math.min(1,e.distanceTo(this.player.pos)/110);i>.04&&this.time-this.lastBoomSound>.09&&(this.lastBoomSound=this.time,hd.explode(Math.min(1,r.count/60),i)),r.count>=6&&this.checkCollapse(e,t)}this.npcs.scare(e,34),this.cars.scare(e,34)}checkCollapse(e,t){if(this.time-this.lastCollapseScan<.25)return;this.lastCollapseScan=this.time;let n=this.world.collapseScan(e.x,e.y,e.z,t);if(!n&&e.y<16&&(n=this.world.foundationScan(e.x,e.z,e.y+t)),!n)return;if(this.chunks.markDirty(n.dirty),this.repair.noteDamage(n.dirty,this.time),this.falling.length>=7){this.debris.burst(e,n.blocks.slice(0,6).map(e=>e[3]),30);return}let r=this.world.groundHeight(e.x,e.z,40),i=Ju(n.blocks,r);this.scene.add(i.mesh),this.falling.push(i)}updateFalling(e){for(let t=this.falling.length-1;t>=0;t--){let n=this.falling[t];if(!Qu(n,e))continue;let r=n.mesh.position.clone();r.y=n.groundY+1,this.debris.burst(r,n.sampleIds,Math.min(40,10+n.blockCount/8)),this.explosions.boom(r,Math.min(12,4+n.blockCount/60));let i=1-Math.min(1,r.distanceTo(this.player.pos)/130);i>.04&&hd.explode(Math.min(1,n.blockCount/150),i),this.npcs.scare(r,40),this.cars.scare(r,40),this.scene.remove(n.mesh),n.mesh.geometry.dispose(),this.falling.splice(t,1)}}updatePlaneRiding(e){let t=this.player;if(this.ridingPlane){let n=this.ridingPlane.group.position.y+this.ridingPlane.deckY,r=this.planes.deckUnder(t.pos.x,t.pos.y,t.pos.z,2.5)===this.ridingPlane;if(e&&t.vel.y>0){this.ridingPlane=null;return}if(!r){this.ridingPlane=null;return}t.pos.y=n,t.vel.y=0,t.grounded=!0;return}if(t.vel.y>0)return;let n=this.planes.deckUnder(t.pos.x,t.pos.y,t.pos.z,2.5);n&&(this.ridingPlane=n,t.pos.y=n.group.position.y+n.deckY,t.vel.y=0,t.grounded=!0,this.hud.toast(`AIRBORNE`,`Standing on a passing airliner`,2.5))}updateBosses(e){if(this.monster){let t={world:this.world,playerPos:this.player.pos,destroyAt:(e,t,n)=>this.destroyAt(e,t,n),damagePlayer:e=>this.damagePlayer(e),fireRocket:(e,t)=>this.fireRocket(e,t),throwBoulder:(e,t)=>this.throwBoulder(e,t),zapAt:e=>this.zapAt(e),igniteAt:(e,t)=>{this.fire.igniteSphere(this.world,e.x,e.y,e.z,t)},floodAt:(e,t)=>{let n=this.flood.floodSphere(this.world,e.x,e.z,t);n.size&&this.chunks.markDirty(n)}};this.monster.update(e,this.time,t),this.hud.setBossHP(this.monster.hp/this.monster.maxHp),this.monster.dying&&this.monster.hp<=0&&!this.monster.dead&&this.monster._rewarded!==!0&&(this.monster._rewarded=!0,this.hud.hideBoss(),this.addScore(1e3+this.wave*250,!0),this.slowmo=1.1,this.shake=1.4,this.explosions.boom(this.monster.group.position.clone().setY(this.monster.group.position.y+14),16),this.grantReward(this.monster.reward)),this.monster.dead&&(this.scene.remove(this.monster.group),this.monster instanceof ou&&this.monster.removeSegmentsFrom(this.scene),this.monster=null,this.bossTimer=25,hd.setMusicIntensity(0));return}if(this.bossTimer-=e,this.bossTimer>0)return;let t=Math.random()*Math.PI*2,n=this.player.pos.x+Math.sin(t)*100,r=this.player.pos.z+Math.cos(t)*100,i=[{make:(e,t)=>new iu(e,t),toast:[`⚠ KAIJU SIGNAL ⚠`,`GORGOSAUR is tearing through the city. Defeat it to learn the BEAM.`]},{make:(e,t)=>new au(e,t),toast:[`⚠ AIRBORNE THREAT ⚠`,`MISSILE MAW inbound. Defeat it for OVERDRIVE THRUSTERS.`]},{make:(e,t)=>new ou(e,t),toast:[`⚠ SEISMIC WEAVE ⚠`,`VOLT SERPENT surfacing. Defeat it to learn the NOVA PULSE.`]},{make:(e,t)=>new su(e,t),toast:[`⚠ HEAVY FOOTFALLS ⚠`,`IRON COLOSSUS approaching. Defeat it to earn the AEGIS SHIELD.`]},{make:(e,t)=>new cu(e,t),toast:[`⚠ SHADOW OVERHEAD ⚠`,`SKY REAVER circling above. Defeat it to salvage its RAILGUN.`]},{make:(e,t)=>new lu(e,t),toast:[`⚠ RAPID MOVEMENT ⚠`,`CRIMSON MANTIS closing fast. Defeat it to earn TWIN SABERS.`]},{make:(e,t)=>new uu(e,t),toast:[`⚠ MOLTEN MASS ⚠`,`MAGMA GOLEM erupting. Defeat it to learn the QUAKE SLAM.`]},{make:(e,t)=>new du(e,t),toast:[`⚠ TREMORS ⚠`,`DEEP MAW burrowing below. Defeat it to mount HEAD VULCANS.`]},{make:(e,t)=>new fu(e,t),toast:[`⚠ FIRESTORM ⚠`,`CINDER WYRM torching the district. Defeat it to claim its FLAMETHROWER.`]},{make:(e,t)=>new pu(e,t),toast:[`⚠ FLOOD WARNING ⚠`,`TIDE LEVIATHAN surfacing. Defeat it to claim its AQUA BLASTER.`]}];if(this.wave++,this.hud.setWave(this.wave),this.bossIndex<i.length){let e=i[this.bossIndex++];this.monster=e.make(n,r),this.hud.toast(e.toast[0],e.toast[1],5)}else{let e=[iu,au,ou,su,cu,lu,uu,du,fu,pu],t=e[Math.floor(Math.random()*e.length)],a=new t(n,r);a.maxHp=a.hp=Math.round(a.maxHp*(1.3+this.powerLevel*.2+(this.wave-i.length)*.15)),a.reward=`repair`,this.monster=a,this.hud.toast(`⚠ WAVE `+this.wave+` ⚠`,a.name+` detected. Defeat it for repairs and a power boost.`,4)}this.monster instanceof ou&&this.monster.addSegmentsTo(this.scene),this.scene.add(this.monster.group),this.hud.showBoss(this.monster.name),hd.roar(),hd.setMusicIntensity(1)}unlockEverything(){let e=this.player.abilities;e.beam=e.boots=e.thrust=e.nova=e.shield=e.blades=e.quake=!0,this.hud.unlock(`beam`,`<b>E (hold)</b> PLASMA BEAM`),this.hud.unlock(`boots`,`<b>SPACE</b> OVERDRIVE THRUSTERS`),this.hud.unlock(`nova`,`<b>Q</b> NOVA PULSE`),this.hud.unlock(`shield`,`AEGIS SHIELD 50%`),this.hud.unlock(`quake`,`<b>G</b> QUAKE SLAM`),this.hud.unlock(`blades`,`TWIN SABERS`),this.touch?.unlock(`beam`),this.touch?.unlock(`nova`),this.touch?.unlock(`quake`);for(let e of gd)this.unlockedWeapons.add(e.id),this.hud.unlockWeapon(e.id);this.selectWeapon(`saber`)}grantWeapon(e,t,n){this.unlockedWeapons.add(e),this.hud.unlockWeapon(e),this.touch?.unlockWeapon(e),this.selectWeapon(e),this.hud.toast(t,n,5)}grantReward(e){switch(hd.jingle(),e){case`beam`:this.player.abilities.beam=!0,this.touch?.unlock(`beam`),this.hud.unlock(`beam`,`<b>E (hold)</b> PLASMA BEAM`),this.hud.toast(`BEAM UNLOCKED`,`Hold E to fire the plasma beam`,5);break;case`thrust`:this.player.abilities.thrust=!0,this.hud.unlock(`boots`,`<b>SPACE</b> OVERDRIVE THRUSTERS`),this.hud.toast(`OVERDRIVE THRUSTERS`,`Your boots climb higher and sprint faster`,5);break;case`nova`:this.player.abilities.nova=!0,this.touch?.unlock(`nova`),this.hud.unlock(`nova`,`<b>Q</b> NOVA PULSE`),this.hud.toast(`NOVA PULSE UNLOCKED`,`Press Q for a devastating shockwave`,5);break;case`shield`:this.player.abilities.shield=!0,this.hud.unlock(`shield`,`AEGIS SHIELD 50%`),this.hud.toast(`AEGIS SHIELD ONLINE`,`All damage is halved`,5);break;case`blades`:this.player.abilities.blades=!0,this.hud.unlock(`blades`,`TWIN SABERS`),this.hud.toast(`TWIN SABERS EQUIPPED`,`Saber combos swing faster and cut deeper`,5);break;case`quake`:this.player.abilities.quake=!0,this.touch?.unlock(`quake`),this.hud.unlock(`quake`,`<b>G</b> QUAKE SLAM`),this.hud.toast(`QUAKE SLAM UNLOCKED`,`Press G to rupture the ground around you`,5);break;case`railgun`:this.grantWeapon(`railgun`,`RAILGUN ACQUIRED`,`Weapon 4 · a piercing lance that bores through city blocks`);break;case`vulcan`:this.grantWeapon(`vulcan`,`HEAD VULCANS ONLINE`,`Weapon 5 · hold ATTACK for rapid-fire chatter`);break;case`flamer`:this.grantWeapon(`flamer`,`FLAMETHROWER SALVAGED`,`Weapon 6 · hold ATTACK to set the city ablaze`);break;case`aqua`:this.grantWeapon(`aqua`,`AQUA BLASTER SALVAGED`,`Weapon 7 · hold ATTACK to flood streets and douse fires`);break;default:this.player.heal(100),this.powerLevel++,this.power=1+(this.powerLevel-1)*.25,this.hud.setPowerLevel(this.powerLevel),this.hud.toast(`POWER LEVEL `+this.powerLevel,`Weapons upgraded · full repairs delivered`,4)}}damagePlayer(e){if(this.player.abilities.shield){e*=.5;let t=this.player.pos.clone();t.y+=5,this.explosions.boom(t,3)}this.player.damage(e),this.hud.damageFlash(),hd.thud(),this.player.hp<=0&&(this.player.respawn(),this.hud.toast(`MECHA DOWN`,`Recovered and redeployed at base`,4))}frame(){let e=Math.min(.05,this.clock.getDelta());this.slowmo>0&&(this.slowmo-=e);let t=this.slowmo>0?e*.35:e;this.time+=t,this.laserCooldown-=t,this.novaCooldown-=t,this.missileCooldown-=t,this.railCooldown-=t,this.vulcanCooldown-=t,this.quakeCooldown-=t,this.dashT-=t,this.comboWindow-=t,this.charging&&(this.chargeT+=t),this.lockOn&&(!this.monster||this.monster.dying)&&(this.lockOn=!1,this.hud.setLockOn(!1)),this.shake=Math.max(0,this.shake-e*2.2),this.comboTimer>0&&(this.comboTimer-=e,this.comboTimer<=0&&this.combo>1&&(this.combo=1,this.hud.setScore(this.score,this.combo)));let n=!1;if(this.started){let e=this.keys.has(`KeyD`)||this.keys.has(`ArrowRight`),r=this.keys.has(`ArrowLeft`),i=this.keys.has(`KeyS`)||this.keys.has(`ArrowDown`),a=this.keys.has(`KeyW`)||this.keys.has(`ArrowUp`),o=!!e-+!!r,s=!!a-+!!i;n=this.keys.has(`Space`);let c=this.keys.has(`ShiftLeft`)||this.keys.has(`ShiftRight`);this.touch&&(o+=this.touch.moveX,s+=this.touch.moveZ,n=n||this.touch.jump,c=c||this.touch.boost),this.ridingPlane&&(this.player.pos.x+=this.ridingPlane.dx,this.player.pos.z+=this.ridingPlane.dz),this.player.update(t,o,s,this.camYaw,n,c)}else this.player.update(t,0,0,this.camYaw,!1,!1);this.planes.update(t,this.player.pos),this.updatePlaneRiding(n),this.chunks.update(this.player.pos.x,this.player.pos.z);let r=[];this.monster&&!this.monster.dying&&r.push(this.monster.group.position),this.npcs.update(t,this.player.pos,r,this.time),this.cars.update(t,this.player.pos),this.updateBosses(t),this.updateBeam(t),this.updateStreams(t),this.updateProjectiles(t),this.updateFalling(t),this.debris.update(t),this.explosions.update(t),this.updateFire(t);let i=this.flood.update(t,this.world);i&&this.chunks.markDirty(i.dirty);let a=this.repair.update(t,this.time,this.player.pos.x,this.player.pos.z);if(a){this.chunks.markDirty(a.dirty);for(let e of a.startedSites)this.npcs.spawnWorkers(e.x,e.z);for(let e=0;e<Math.min(3,a.restored.length);e++){let e=a.restored[Math.floor(Math.random()*a.restored.length)];this.debris.burst(new V(e.x+.5,e.y+1,e.z+.5),[18],2)}}let o=this.sky.update(t,this.time,this.player.pos,this.camera);this.scene.background.copy(o.skyColor),this.scene.fog.color.copy(o.fogColor),this.sun.intensity=o.sunIntensity,this.sun.position.copy(o.sunDir),this.hemi.intensity=o.hemiIntensity,this.hud.setHP(this.player.hp/this.player.maxHp),this.hud.update(t),this.updateCamera(),this.renderer.render(this.scene,this.camera)}updateFire(e){let t=this.fire.update(e,this.world);if(!t)return;t.dirty.size&&(this.chunks.markDirty(t.dirty),this.repair.noteDamage(t.dirty,this.time));let n=null;for(let e of t.destroyed)Math.random()<.5&&this.debris.burst(new V(e[0]+.5,e[1]+.5,e[2]+.5),[12],3),(!n||e[1]<n[1])&&(n=e);n&&n[1]<10&&(xd.set(n[0]+.5,n[1]+.5,n[2]+.5),this.checkCollapse(xd,5))}updateProjectiles(e){let t=e=>e===`laser`||e===`missile`||e===`charge`;for(let n=this.projectiles.length-1;n>=0;n--){let r=this.projectiles[n];if(r.life-=e,r.kind===`rocket`&&(r.vel.y-=2*e),r.kind===`boulder`&&(r.vel.y-=16*e,r.mesh.rotation.x+=e*3,r.mesh.rotation.z+=e*2),r.kind===`missile`){let t=this.monster;if(t&&!t.dying){xd.copy(t.group.position),xd.y+=14,xd.sub(r.pos).normalize();let n=r.vel.length();r.vel.lerp(xd.multiplyScalar(n),Math.min(1,e*2.5)),r.vel.setLength(Math.min(52,n+40*e))}r.mesh.lookAt(r.pos.clone().add(r.vel))}r.pos.addScaledVector(r.vel,e),r.mesh.position.copy(r.pos);let i=!1;if((this.world.solidAt(r.pos.x,r.pos.y,r.pos.z)||r.pos.y<.2)&&(i=!0),t(r.kind)){let e=r.kind===`charge`?4:2;this.hitMonster(r.pos,e,(r.dmg??7)*(r.kind===`laser`?this.power:1))&&(i=!0)}else r.pos.distanceTo(this.player.pos)<(r.kind===`boulder`?8:7)&&(i=!0,this.damagePlayer(r.kind===`boulder`?22:16));if(i){let e=r.kind===`charge`?4.5:r.kind===`laser`?2.4:r.kind===`missile`?3:r.kind===`boulder`?5:3.6;this.destroyAt(r.pos,e,.2)}(i||r.life<=0)&&(this.scene.remove(r.mesh),r.mesh.geometry.dispose(),r.mesh.material.dispose(),this.projectiles.splice(n,1))}}updateCamera(){let e=this.player.pos.clone();e.y+=9.9;let t=new V(Math.sin(this.camYaw)*Math.cos(this.camPitch),Math.sin(this.camPitch),Math.cos(this.camYaw)*Math.cos(this.camPitch)),n=this.world.raycast(e.x,e.y,e.z,t.x,t.y,t.z,28),r=n?Math.max(3.5,n.dist-.8):28;if(this.camera.position.copy(e).addScaledVector(t,r),this.shake>.01){let e=this.shake*1.6;this.camera.position.x+=(Math.random()-.5)*e,this.camera.position.y+=(Math.random()-.5)*e,this.camera.position.z+=(Math.random()-.5)*e}this.camera.lookAt(e)}};